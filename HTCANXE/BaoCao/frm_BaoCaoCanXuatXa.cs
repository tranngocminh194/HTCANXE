...
{
    public partial class frm_BaoCaoCanXuatXa : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        private int id_phieu;
        private string _loaiCan = "XUAT";
        ...
        private void frm_BaoCaoCanXuatXa_Load(object sender, EventArgs e)
        {
        ...
        private void btn_xuatbaocao_Click(object sender, EventArgs e)
        {
            ...
            var Tong = Common.db.Fn_GetListCanXeWhereSumSoNiem(_loaiCan, "ALL", tungay, denngay, khachhang, congtrinh, nhomhang, loaihang, soxe, soromooc, noixuat, Common.gTramCan).Single();
