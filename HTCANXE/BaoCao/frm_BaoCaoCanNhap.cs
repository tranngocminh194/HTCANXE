...
{
    public partial class frm_BaoCaoCanNhap : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        private int id_phieu;
        private string _loaiCan = "NHAP";
        ...
        private void frm_BaoCaoCanNhap_Load(object sender, EventArgs e)
        {
