...
{
    public partial class rpt_DanhSachNghiemThuCanXe : DevExpress.XtraReports.UI.XtraReport
    {
        private string _MocThoiGian;

        public string mocthoigian
        {
            set { _MocThoiGian = value; }
        }
        ...
        public rpt_DanhSachNghiemThuCanXe()
        {
            InitializeComponent();
        ...
        private void rpt_DanhSachNghiemThuCanXe_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            txt_tramcan.Text = @"TT.CUNG ƯNG VẬT TƯ".ToUpper();txt_ngayin.Text = _MocThoiGian;
        }
    }
}
