...
{
    public partial class rpt_DanhSachCanXeXa : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private double _tsniem;
        public double tongsoniem
        {
            set
            {
                _tsniem = value;
        ...
        public void BindData()
        {
            ...
            xrTableCell_soniem.DataBindings.Add("Text", DataSource, "SoNiem");
        }

        private void rpt_DanhSachCanXeXa_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            xrTableCell_tongsoniem.Text = String.Format("{0:#,0}", _tsniem);
