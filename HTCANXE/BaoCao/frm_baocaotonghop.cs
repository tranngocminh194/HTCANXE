...
{
    public partial class frm_baocaotonghop : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void frm_baocaotonghop_Load(object sender, EventArgs e)
        {
            ...
            cbo_noixuat.Text = @"X";
            cbo_tramcan.Text = Common.gTramCan;
        ...
        private void cbo_loaican_EditValueChanged(object sender, EventArgs e)
        {
